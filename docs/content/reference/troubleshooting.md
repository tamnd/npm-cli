...
Most of these come down to network reality or how npm serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

npm rate-limits like any public site. npm already paces
...
Where a surface is gated, npm reads a cookie or token you supply
...
`npm`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what npm actually did
